          ...
          <div class="row">
            <div class="col-sm-6 col-12">
              <div class="location-filter">
                <button href="#" type="button" data-toggle="modal" data-target="#exampleModalLong"><img src="{{asset('public/frontEnd/')}}/images/LOCATION.png" alt="" class="location-icon" />Select Location</button>
              </div>
              <!-- Modal -->
                          ...
                          <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-home{{$division->id}}" role="tabpanel" aria-labelledby="v-pills-home-tab{{$division->id}}">
                              ...
                              <ul class="modal-second-menu">
                                ...
                                <li>
                                  <a data-toggle="collapse" href="#modal-collapse{{$district->id}}" role="button" aria-expanded="false" aria-controls="modal-collapse"> {{$district->dist_name}} <i class="fa fa-angle-down"></i> </a>
                                    ...
                                    <div class="collapse" id="modal-collapse{{$district->id}}">
                                      <div class="tree-menu demo custom-tree" id="tree-menu">
                                        <ul>
                                          ...
                                          <li>
                                            <a href="{{url('location/'.$division->slug.'/'.$district->slug.'/'.$thana->slug)}}">{{$thana->thana_name}}</a>
                                            <ul>
                          ...
                          <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-category{{$category->id}}" role="tabpanel" aria-labelledby="v-pills-category-tab{{$category->id}}">
                              ...
                              <ul class="modal-second-menu">
                                ...
                                <li>
                                  <a href="{{url('category/'.$category->slug.'/'.$subcategory->slug)}}"> {{$subcategory->subcategoryName}} <i class="fa fa-angle-down"></i> </a>
                                </li>
                                @endforeach
                              </ul>
                            </div>
          ...
          <div class="locationad-inner">
            ...
            <div id="location-ads" class="location-ads">
              <ul>
                ...
                <li>
                  <a href="{{url('/location/'.$division->slug)}}">{{$division->name}} <span>({{$division->ads->count()}})</span></a>
                </li>
                @endforeach
              </ul>
            </div>
                        ...
                        <div class="list-ad-info">
                          ...
                          <div class="common_area">
                            <div class="post-location">
                              <p>
                                <i class="fa fa-map-marker icon_color" aria-hidden="true"></i> {{$value->division->name}} <i class="fa fa-angle-right"></i> {{$value->district->dist_name}} @if($value->thana !=NULL)
                                <i class="fa fa-angle-right"></i> {{$value->thana->thana_name}} @endif @if($value->union !=NULL) <i class="fa fa-angle-right"></i> {{$value->union->union_name}} @endif
                              </p>
                            </div>
