<!DOCTYPE html>
<!-- saved from url=(0032)http://kroyandbikroy.com/ -->
<html lang="en" style="" class=" eventlistener localstorage no-touchevents no-forcetouch">
					...
					<div class="navbar-collapse collapse" id="navbarsDefault">
						...
						<ul class="nav navbar-nav ms-auto navbar-right">
							...
							<li class="nav-item dropdown no-arrow open-on-hover d-md-block d-sm-none d-none">
								...
								<ul id="authDropdownMenu" class="dropdown-menu user-menu shadow-sm" style="left: 0">
