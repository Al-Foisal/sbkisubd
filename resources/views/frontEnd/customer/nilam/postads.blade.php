            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <div class="customer-body">
                        <div class="title">
                            <p>Post New Bidding Ads</p>
                        </div>
                        <div class="cbmain-content">
                            <form action="{{ url('/customer/0/nilam/control-panel/post-new-ads') }}" method="POST" novalidate
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('adsduration') }}" required>
