                    ...
                    <form role="form" action="{{url('editor/subcategory/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            <label>Subcategory Name in English</label>
                            <input type="text" name="en_subcategoryName" class="form-control{{ $errors->has('en_subcategoryName') ? ' is-invalid' : '' }}" value="{{$edit_data->en_subcategoryName}}">
                            @if ($errors->has('en_subcategoryName'))
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $errors->first('en_subcategoryName') }}</strong>
                            </span>
                            @endif
                         </div>
                         <div class="form-group">
                          <label>Subcategory Name in Bangla</label>
                          <input type="text" name="bn_subcategoryName" class="form-control{{ $errors->has('bn_subcategoryName') ? ' is-invalid' : '' }}" value="{{$edit_data->bn_subcategoryName}}">
                          @if ($errors->has('bn_subcategoryName'))
                          <span class="invalid-feedback" role="alert">
                            <strong>{{ $errors->first('bn_subcategoryName') }}</strong>
                          </span>
                          @endif
                       </div>
                        <!-- form group -->
