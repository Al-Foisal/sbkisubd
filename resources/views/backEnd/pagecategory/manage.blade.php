                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        ...
                        <div class="quick-button">
                            <a href="{{ url('editor/pagecategory/create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($show_data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->status == 1 ? 'Y' : 'N' }}</td>
                                                <td>{{ $value->en_pagename }}</td>
                                                <td>{{ $value->bn_pagename }}</td>
                                                <td>{!! $value->en_text !!}</td>
                                                <td>{!! $value->bn_text !!}</td>
                                                <td>
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form action="{{ url('editor/pagecategory/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('editor/pagecategory/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('editor/pagecategory/edit/' . $value->id) }}"
