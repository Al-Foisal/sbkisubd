...
@section('title', 'Update Division Childcity')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>Update Division Childcity</h5>
                        </div>
                        <div class="quick-button">
                            <a href="{{ route('editor.divisionchildcity.index') }}"
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Update Division Childcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.divisionchildcity.update',$city->id) }}" method="POST"
    ...
    <script type="text/javascript">
        document.forms['editForm'].elements['division_subcity_id'].value = "{{ $city->division_subcity_id }}"
