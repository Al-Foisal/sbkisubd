                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        ...
                        <div class="quick-button">
                            <a href="{{ url('editor/package/create') }}" class="btn btn-primary btn-actions btn-create">
                                                ...
                                                <td>
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form action="{{ url('editor/package/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('editor/package/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('editor/package/edit/' . $value->id) }}"
