...
@section('title', 'Update Thana Childcity')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Thana Childcity</a></li>
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>Update Thana Childcity</h5>
                        </div>
                        <div class="quick-button">
                            <a href="{{ route('editor.thanachildcity.index') }}"
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Update Thana Childcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.thanachildcity.update',$city->id) }}" method="POST"
                                      ...
                                      @method('PUT')
                                        <div class="card-body">
                                            ...
                                            <!-- form group -->
                                            <div class="form-group">
                                                <label>Thana Subcity</label>
                                                <select name="thana_subcity_id"
                                                    class="form-control select2 {{ $errors->has('thana_subcity_id') ? ' is-invalid' : '' }}"
                                                    value="{{ old('thana_subcity_id') }}">
                                                    <option value="">Select</option>
                                                    @foreach ($thanasubcity as $value)
    ...
    <script type="text/javascript">
        document.forms['editForm'].elements['thana_subcity_id'].value = "{{ $city->thana_subcity_id }}"
