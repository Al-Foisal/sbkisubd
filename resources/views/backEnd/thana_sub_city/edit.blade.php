...
@section('title', 'Update Thana Subcity')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Thana Subcity</a></li>
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>Update Thana Subcity</h5>
                        </div>
                        <div class="quick-button">
                            <a href="{{ route('editor.thanasubcity.index') }}"
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Update Thana Subcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.thanasubcity.update',$city->id) }}" method="POST"
                                      ...
                                      @method('PUT')
                                        <div class="card-body">
                                            ...
                                            <!-- form group -->
                                            <div class="form-group">
                                                <label>Thana City</label>
                                                <select name="thana_id"
                                                    class="form-control select2 {{ $errors->has('thana_id') ? ' is-invalid' : '' }}"
                                                    value="{{ old('thana_id') }}">
    ...
    <script type="text/javascript">
        document.forms['editForm'].elements['thana_id'].value = "{{ $city->thana_id }}"
