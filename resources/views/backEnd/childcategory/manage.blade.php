...
@section('title', 'Manage Childcategory')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        ...
                        <div class="quick-button">
                            <a href="{{ url('editor/childcategory/create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($show_data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->en_childcategoryName }}</td>
                                                <td>{{ $value->bn_childcategoryName }}</td>
                                                <td>{{ $value->en_subcategoryName }}</td>
                                                    ...
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form
                                                                        action="{{ url('editor/childcategory/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('editor/childcategory/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('editor/childcategory/edit/' . $value->id) }}"
