...
@section('title', 'Update District Subcity')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">District Subcity</a></li>
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>Update District Subcity</h5>
                        </div>
                        <div class="quick-button">
                            <a href="{{ route('editor.districtsubcity.index') }}"
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Update District Subcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.districtsubcity.update',$city->id) }}" method="POST"
    ...
    <script type="text/javascript">
        document.forms['editForm'].elements['district_id'].value = "{{ $city->district_id }}"
