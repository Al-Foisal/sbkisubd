...
@section('title', 'Create Division Subcity')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>Create Division Subcity</h5>
                        </div>
                        <div class="quick-button">
                            <a href="{{ route('editor.divisionsubcity.index') }}" class="btn btn-primary btn-actions btn-create">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Create Division Subcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.divisionsubcity.store') }}" method="POST"
