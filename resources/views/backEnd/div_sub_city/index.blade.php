...
@section('title', 'Manage Division Subcity')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        ...
                        <div class="quick-button">
                            <a href="{{ route('editor.divisionsubcity.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($cities as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->en_name }}</td>
                                                <td>{{ $value->bn_name }}</td>
                                                <td>{{ $value->divisioncity->en_name}}</td>
                                                <td>
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ route('editor.divisionsubcity.edit',$value->id) }}"
                                                                    title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                                            </li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('editor.divisionsubcity.destroy', $value->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button type="submit"
