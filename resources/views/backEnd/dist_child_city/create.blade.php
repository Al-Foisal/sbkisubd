...
@section('title', 'Create District Childcity')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        ...
                        <div class="quick-button">
                            <a href="{{ route('editor.districtchildcity.index') }}" class="btn btn-primary btn-actions btn-create">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Create District Childcity</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ route('editor.districtchildcity.store') }}" method="POST"
