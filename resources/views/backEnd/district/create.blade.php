                      ...
                      <div class="card-body">
                        @foreach(config('app.languages') as $locale =>$locale_name)
                         <div class="form-group">
                              <label>District Name in {{ $locale_name }}</label>
                              <input type="text" name="{{ $locale }}_dist_name" class="form-control{{ $errors->has($locale.'_dist_name') ? ' is-invalid' : '' }}" value="{{ old($locale.'_dist_name') }}">

                              @if ($errors->has($locale.'_dist_name'))
                              <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first($locale.'_dist_name') }}</strong>
                              </span>
                              @endif
                          </div>
                          @endforeach
